...
<p align="center">
	<img src="https://i.ibb.co/RTJLmzT/Ganzzz.jpg" width="35%" style="margin-left: auto;margin-right: auto;display: block;">
</p>
...
```bash
git clone https://github.com/SATGANZBOT/gege-geming
cd gege-geming
npm install
```
